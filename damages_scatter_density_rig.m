...
%% Datas
fid = fopen('all_level_damages_rig.csv'); % This function open the file specified in the arg
...
saveas(gcf,'rigid\results from scatter density\Local damages, east fecade.jpg')
densityPlotScatter([Sa'; local_W_DL'], 'Sa $[m/s^2]$', '$DL_i$', 'Local damages, west fecade')
saveas(gcf,'rigid\results from scatter density\Local damages, west fecade.jpg')
...
saveas(gcf,'rigid\results from scatter density\Macro damages, east fecade.jpg')
densityPlotScatter([Sa'; macro_W_DL'], 'Sa $[m/s^2]$', '$DL_i$', 'Macro damages, west fecade')
saveas(gcf,'rigid\results from scatter density\Macro damages, west fecade.jpg')
